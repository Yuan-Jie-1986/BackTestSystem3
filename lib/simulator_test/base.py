...
class BacktestSys(object):
    ...
    def prepare(self):
        ...
        for sub_class, sub_data in raw_data.items():
            self.data[sub_class] = {}
            for d in sub_data:
                self.data[sub_class][d['name']] = DataClass(nm=d['name'])
                ...
                self.data[sub_class][d['name']].add_dt(dict_res['date'])
                ...
                print(self.data[sub_class][d['name']].__dict__)
